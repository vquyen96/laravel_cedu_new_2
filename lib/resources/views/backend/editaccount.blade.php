		...
		<form method="post" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="form-group col-md-6">
	                ...
	                <img style="cursor: pointer;" id="avatar" class="cssInput thumbnail tableImgAvatar" width="s%" src="{{ file_exists(storage_path('app/avatar/resized50-'.$item->img)) ? asset('lib/storage/app/avatar/resized50-'.$item->img) : 'img/no-avatar.jpg'}}">
				</div>
			</div>
