                ...
                <div class="row formPass">
                    <div class="col-md-12 col-sm-12">
                        <div class="code">
                            ...
                            <input type="password" name="re_password" placeholder="Nhập lại mật khẩu" autocomplete="off"
                                   required>
                            ...
                            <p><i>Lưu ý: Nhập mã mới nhất bạn nhận được </i></p>
                            <p><i>Nếu bạn không nhận đưuọc email hoặc gặp lỗi vui lòng liên hệ với chúng tôi theo
                                    số </i></p>
                            <p><strong>Hotline: 1800 6886</strong></p>
                        </div>
                    </div>
