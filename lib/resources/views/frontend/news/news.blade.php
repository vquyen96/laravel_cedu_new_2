				...
				<div class="col-md-4 col-sm-4 col-12">
					<div id="content-right">
						...
						<a href="{{asset('news/detail/'.$item->news_slug)}}"" class="news">
							<div class="img" style="background:url('{{ file_exists(storage_path('/app/news/resized360-'.$item->news_img)) ? asset('lib/storage/app/news/resized360-'.$item->news_img) : asset('lib/storage/app/news/'.$item->news_img)}}') no-repeat center /cover;"></div>
							<p>{{$item->news_title}}</p>
						</a>
						@endforeach
