...
<div style="background:#ddd; padding: 20px; font-family: 'Roboto', sans-serif;">
    <div style="width: 700px;margin: auto;display: flex;">
        <div style="background: #35465c;">
            ...
            <div style="background: url('{{asset('lib/storage/app/course/'.$code->orderDe->course->cou_img)}}') no-repeat center/cover;width: 100%;height: 300px;">
            </div>
        </div>
        <div style="width: 100%;height: 700px;background: #eeeeee;">
            <div class="logo">
