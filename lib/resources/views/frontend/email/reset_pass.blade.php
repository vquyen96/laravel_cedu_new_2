...
<div style="background:#ddd; padding: 20px;">
    <div style="width: 972px;margin: 20px auto; background:url('{{asset('public/layout/frontend/img/vectorsmartobject2.png')}}') no-repeat;background-size: cover;padding: 30px;display: flex;">
        ...
        <div style="width: 50%;height: 100%;margin-left: 50%;padding-top: 100px;">
            <div style="padding: 40px;">
                ...
                <a href="{{asset('forgot_pass/email/'.$email.'/'.$code)}}" style="display: block;width: 150px;line-height: 45px;background: #35465c;text-align: center;color: #fff;font-size: 14px;font-weight: bold;text-decoration: none;border-radius: 20px;margin-top: 10px;margin-bottom: 20px;">XÁC NHẬN</a>
